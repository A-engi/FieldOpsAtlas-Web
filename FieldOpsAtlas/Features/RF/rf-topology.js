/* ==========================================================================
 ...
 /* ==========================================================================
   ...
   Version: 1.1.68-topology-map-compat
...
(() => {
  ...
  const VERSION = "1.1.68-topology-map-compat";
...
<aside class="rf-topology-key rf-map-key" aria-label="RF topology key" data-rf-topology-key data-rf-map-key>
  <div class="rf-topology-key-title rf-map-key-title">Key</div>
  <ul class="rf-topology-key-list rf-map-key-list">
    <li>
      <span class="rf-topology-key-swatch rf-map-key-swatch is-core" aria-hidden="true"></span>
      <span>Core site</span>
    </li>
    <li>
      <span class="rf-topology-key-swatch rf-map-key-swatch is-relay" aria-hidden="true"></span>
      <span>Relay site</span>
    </li>
    <li>
      <span class="rf-topology-key-line rf-map-key-line is-selected" aria-hidden="true"></span>
      <span>Selected path</span>
    </li>
    <li>
      <span class="rf-topology-key-line rf-map-key-line is-standby" aria-hidden="true"></span>
...
`;
  ...
  function renderMount(mount, sourceGraph) {
    ...
    const root = svg("svg", {
      class: "rf-topology-svg rf-network-map-svg",
  ...
  function attachTopologyKey(mount) {
    ...
    mapPaper
      .querySelectorAll(":scope > .rf-topology-key, :scope > .rf-map-key")
  ...
  function initAll(root = document) {
    root
      .querySelectorAll("[data-rf-topology], [data-rf-network-map]")
      .forEach(initMount);
  }
  ...
  window.FieldOpsRFTopology = api;
  window.FieldOpsRFNetworkMap = api;
