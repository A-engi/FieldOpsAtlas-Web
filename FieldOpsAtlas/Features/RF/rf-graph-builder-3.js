/* ==========================================================================
   FieldOps Atlas RF Builder 3 — opaque colour with triangle borders
   File: FieldOpsAtlas/Features/RF/rf-graph-builder-3.js
   Version: 1.1.303-builder-3-triangle-border-colour
...
(() => {
  ...
  const VERSION = "1.1.303-builder-3-triangle-border-colour";
  const MODE = "three-neon-peak-triangle-border-colour-builder-3";
  ...
  function createSingleLayerMaterial(THREE) {
    ...
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          float triangleBorderStrength = mix(
            0.72,
            0.96,
            max(layer1Area, layer2Presence)
          );
          colour = mix(
            colour,
            uOutline,
            triangleBorder * triangleBorderStrength
          );
          colour += uGlow * triangleBorder * 0.14;
    ...
    material.name = "rf-double-sided-opaque-colour-outer-material";
    return material;
  }
