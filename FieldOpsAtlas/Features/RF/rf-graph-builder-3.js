/* ==========================================================================
   FieldOps Atlas RF Builder 3 — double-sided opaque colour topology forks 360
   File: FieldOpsAtlas/Features/RF/rf-graph-builder-3.js
   Version: 1.1.302-builder-3-double-sided-opaque-colour
...
(() => {
  ...
  const VERSION = "1.1.302-builder-3-double-sided-opaque-colour";
  const MODE = "three-neon-peak-double-sided-opaque-colour-builder-3";
