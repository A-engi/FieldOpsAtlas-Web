...
(() => {
  ...
  function renderRegionList() {
    ...
    elements.regionList.innerHTML = OUTAGE_REGIONS.map((region) => {
      ...
      const selected = state.visibleRegions.has(region.id);

      return [
        `<button class="outage-region-button${active ? " is-pending" : ""}${selected ? " is-selected" : ""}" style="--outage-region-x:${region.x}%;--outage-region-y:${region.y}%" type="button" data-region-toggle="${escapeAttribute(region.id)}" aria-pressed="${String(active)}">`,
