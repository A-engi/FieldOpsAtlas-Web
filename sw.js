const CACHE_NAME = "fieldops-atlas-v1.1.23-rf-3d-render";
...
const CORE_FILES = [
  ...
  "./FieldOpsAtlas/Features/RF/3d-render.js?v=1.2.2-quarter-dock-3d-render",
  "./FieldOpsAtlas/Features/RF/rf-graph-builder-3.js?v=1.2.2-quarter-dock-adapter",
